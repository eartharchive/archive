defmodule ArchiveWeb.RequestControllerTest do
  use ArchiveWeb.ConnCase

  alias Archive.Archives

  @create_attrs %{content: "some content", status: "some status", title: "some title"}
  ...
  def fixture(:request) do
    {:ok, request} = Archives.create_request(@create_attrs)
    request
  end
