defmodule Archive.AccountsTest do
  ...
  describe "credentials" do
    ...
    test "create_credential/1 with valid data creates a credential" do
      ...
      assert credential.uid == "some uid"
      assert credential.verified == true
    end
    ...
    test "update_credential/2 with valid data updates the credential" do
      ...
      assert credential.uid == "some updated uid"
      assert credential.verified == false
    end
